...
// Cache the locale string to avoid re-evaluating POSIX env vars and
// avoiding expensive Intl.DateTimeFormat validations.
// null = not yet computed; undefined = computed but invalid/fallback.
