...
let _getSystemContext: any;
function getSystemContext(...args: any[]) {
  if (!_getSystemContext) _getSystemContext = require('./context.js').getSystemContext;
  return _getSystemContext(...args);
}
